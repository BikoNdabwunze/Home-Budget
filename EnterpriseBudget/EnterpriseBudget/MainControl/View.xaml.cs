    ...
    public partial class View : Window, InterfaceView
    {
        ...
        private void FacultyButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (employee != null)
            {
                ...
                readOnlyDataView.presenter = new DeptBudgets.Presenter(readOnlyDataView, (DeptBudgets.InterfaceView)readOnlyDataView, employee.deptartmentID);
        ...
        private void ChairPersonButton_Clicked(object sender, RoutedEventArgs e)
        {
            ...
            if (employee != null)
            {
                ...
                readWriteView.presenter = new DeptBudgets.Presenter(readWriteView, (DeptBudgets.InterfaceView)readWriteView, employee.deptartmentID);
